...
import { Shop, Login, Register, SingleProduct, AddToCartButton, Admin, AdminUserData, AdminCreateProduct, AdminEditProduct, Checkout, Complete } from './components';
    ...
    return (
      <div>
          ...
          <Routes>
              ...
              <Route path="/complete" element={<Complete navigate={navigate} />} />
